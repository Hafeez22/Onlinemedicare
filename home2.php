		...
		$(document).ready( function() {
			$("#immersive_slider").immersive_slider({
				  container: ".main"
							 ...
							 <?php  
/*							 
							 $select_img =mysqli_query($con,"SELECT * FROM add_hospital ORDER by pharmacy_stocks_id DESC limit 4");
					while ($row_img=mysqli_fetch_array($select_img)) 		
					{	 ?>
							<figure>
							<?php echo 
							'<img class="img-responsive" style="height:407px;" alt="" src="uploads/'.$row_img["file"].'">';
							?>
							</figure>
							<?php }*/ ?>
							</div>
