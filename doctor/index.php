...
$query1=mysqli_query($con,"SELECT * FROM add_doctor WHERE name='$username' AND Password='$password'");
if($r = mysqli_fetch_assoc($query1))
{
	$_SESSION['dname']=$username;	
	
echo "<script>alert('Login Succesfully'); window.location = './add_pres.php';</script>";
}
else
{
 ...
 <?php include('front_top.php');?>
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
			...
			<h1 class="text-center login-title">Doctor Login</h1>
