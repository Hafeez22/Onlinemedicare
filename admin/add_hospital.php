<div class="container">
 ...
 if(isset($_POST['submit']))
			...
			$query1=mysqli_query($con,"insert into add_hospital values('','$pharmacy_category','$hosp_name','$file','$addr','$mob')");
				if($r = $query1)
				{
				echo "<script>alert('Added Succesfully'); window.location = './add_hospital.php';</script>";
				}
				else
				{
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data">
	 ...
	 <div class="form-group">
		  <label class="control-label col-sm-2" for="pharmacy_category">Hospital Category</label>
		  <div class="col-sm-4">
    <?php
   
    $query = mysqli_query($con,"SELECT * FROM pharmacy_category");
    $rowCount = mysqli_num_rows($query);
    ?>
    <select class="form-control" name="pharmacy_category" id="country">
	...
	<div class="form-group">
	  <label class="control-label col-sm-2" for="medicine_brand">Hospital Name</label>
	  <div class="col-sm-4">
		<input type="text" class="form-control" name="hosp_name" id="medicine_brand" placeholder="Enter Hospital Name" required>
	  </div>
	</div>
	<div class="form-group">
	...
	<form method="post" action="">
		...
		if($querry1 && $query1)
		{
		echo "<script>alert('Deleted Successfully'); window.location = './add_hospital.php';</script>";
		}
		} ?>	
